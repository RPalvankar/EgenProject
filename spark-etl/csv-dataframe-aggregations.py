...
bucket_streaming_files = "gs://ritvik-csv-streams" # Bucket to read the streaming files from 

bucket_transformed_output = "gs://ritvik-streaming" # Bucket to write the transformed output to 
